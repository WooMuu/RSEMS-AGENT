...
/**
 * Created by zhongxiaozhong on 2017/4/26.
 */
public class DateUtils {
    ...
    public static Integer currentTimeStamp(Date date) {

        try {
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            return Integer.parseInt(String.valueOf(sdf.parse(getDateLongString(date).toString()).getTime() / 1000));
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static Integer firstTimeStamp(Date date) {
        try {
            String dateStr = getDateString(date);
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            return Integer.parseInt(String.valueOf(sdf.parse(getDateLongString(string2Date(dateStr)).toString()).getTime() / 1000));
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static String getFormartDateTimeString(Timestamp time) {
    ...
    public static int daysFrom(Timestamp time) {
     ...
     */
    public static Timestamp timeFromString(String time) {
        Date date;
        try {
    ...
    private static final SimpleDateFormat dateFormatG = new SimpleDateFormat(DATE_PATTERN);
    ...
    public static Date getNeedTime(int hour,int minute,int second,int addDay,int month,int year){
        Calendar calendar = Calendar.getInstance();
        calendar.set(Calendar.HOUR_OF_DAY,hour);
        calendar.set(Calendar.MINUTE,minute);
        calendar.set(Calendar.SECOND,second);
    ...
    public static Long getTimeInSecond(String time) throws ParseException {
        Calendar calendar = Calendar.getInstance();
    ...
    public  static void main(String[] args){
        String currentStart = String.valueOf(DateUtils.getNeedTime(0,0,0,0).getTime()/1000);
        String currentEnd = String.valueOf(DateUtils.getNeedTime(23,59,59,0).getTime()/1000);
        System.out.print("currentStart: "+currentStart+"  currentEnd: "+currentEnd);
    }
}
